...
import { caseStudySchema, type CaseStudyFormValues } from "@/lib/validations/case-study.schema";
import { useCreateCaseStudy, useUpdateCaseStudy } from "@/lib/react-query/case-studies.hooks";
import { type CaseStudy } from "@/lib/services/case-studies.service";
import { useRouter } from "next/navigation";
import { StringArrayInput } from "@/components/cms/string-array-input";
...
export function CaseStudyForm({ initialData, id }: CaseStudyFormProps) {
  ...
  return (
    <FormLayout
      ...
      backHref="/dashboard/case-studies"
