...
import { useContact } from "@/lib/react-query/contacts.hooks";
...
import { ContactStatusBadge } from "@/components/operations/contact-status-badge";
...
export default function ContactDetailPage({ params }: ContactDetailPageProps) {
  ...
  const canManage = role === "Founder" || role === "CEO" || role === "Marketing" || role === "HR";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <Link href="/dashboard/contacts" className="text-muted-foreground hover:text-foreground flex items-center gap-1 text-sm font-medium">
