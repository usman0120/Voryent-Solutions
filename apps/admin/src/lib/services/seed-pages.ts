...
const defaultPages = [
  {
    ...
    contentBlocks: {
      hero: {
        ...
        description: "Voryent Solutions partners with ambitious teams to architect, build, and scale software that drives real business outcomes — from cloud infrastructure to intelligent interfaces.",
      },
      servicesPreview: {
        title: "What We Do",
        description: "End-to-end engineering services designed to take your product from concept to scale.",
      },
      whyVoryent: {
        title: "Why Voryent",
        description: "We combine deep engineering discipline with genuine partnership to deliver outcomes that matter — not just features.",
        items: [
          {
      ...
      process: {
        title: "How We Work",
        description: "A proven, repeatable process that minimises risk and maximises velocity at every stage.",
        items: [
          {
            step: "01",
            icon: "Lightbulb",
            title: "Discover",
            description: "We listen deeply, audit your existing systems, and map business objectives to technical requirements.",
          },
          {
            step: "02",
            icon: "Search",
          ...
          },
          {
            ...
            icon: "Rocket",
            title: "Deliver",
            description: "Agile sprints with weekly demos, automated testing, and production-grade deployments at every milestone.",
          },
          {
            step: "04",
            icon: "Headphones",
            title: "Support",
            description: "Post-launch monitoring, performance tuning, and 24/7 incident response to keep your systems running flawlessly.",
          },
        ]
      },
      featuredWork: {
      ...
      cta: {
        ...
        description: "Let's discuss your next project. No sales pitch — just a genuine conversation about what you're trying to achieve and how we can help.",
      }
    }
  },
  {
    ...
    contentBlocks: {
      hero: {
        title: "Building modern digital products with engineering excellence and long-term partnerships.",
        description: "We are a dedicated team of engineers, designers, and strategists. We build scalable, high-performance software solutions for ambitious organizations who demand robust architectures, intelligent AI workflows, and flawless user experiences.",
      },
      whoWeAre: {
        title: "Who We Are",
        paragraphs: [
      ...
      missionVision: {
        mission: "To empower organizations with robust, modern digital products that solve complex problems, driving sustainable business growth through relentless engineering excellence and uncompromising quality.",
        vision: "To be the trusted technology partner of choice for ambitious companies globally, recognized for building resilient, AI-enhanced architectures that define the next generation of software."
      },
      coreValues: {
        title: "Core Values",
        description: "The fundamental principles that guide our decisions, shape our culture, and define how we build.",
        items: [
      ...
      processSteps: {
        title: "Our Process",
        description: "A systematic, transparent approach from the first conversation to continuous deployment.",
        items: [
