    ...
    <Footer
      ...
      description={
        <div className="space-y-4">
          <p>Empowering digital products with next-generation design and engineering. We build scalable, resilient software that drives real business outcomes.</p>
          {contact && (
            <div className="space-y-2 text-sm text-muted-foreground mt-4">
              {contact.email && <p><strong>Email:</strong> <a href={`mailto:${contact.email}`} className="hover:text-foreground">{contact.email}</a></p>}
              {contact.phone && <p><strong>Phone:</strong> <a href={`tel:${contact.phone}`} className="hover:text-foreground">{contact.phone}</a></p>}
              {contact.whatsapp && <p><strong>WhatsApp:</strong> <a href={`https://wa.me/${contact.whatsapp.replace(/[^0-9]/g, "")}`} className="hover:text-foreground">{contact.whatsapp}</a></p>}
