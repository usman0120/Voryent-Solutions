...
import { useReport, useUpdateReport } from "@/lib/admin/react-query/reports.hooks";
import { useAuth } from "@/providers/auth-provider";
import { use } from "react";
import Link from "next/link";
import { Card, CardHeader, CardTitle, CardContent } from "@voryent/ui";
import { Button } from "@voryent/ui";
import { ReportStatusBadge } from "@/components/admin/operations/report-status-badge";
import { 
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <Link href="/admin/dashboard/reports" className="text-muted-foreground hover:text-foreground flex items-center gap-1 text-sm font-medium">
