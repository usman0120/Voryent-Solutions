...
import { type FaqItem, faqService } from "@/lib/admin/services/faq.service";
...
export const columns: ColumnDef<FaqItem>[] = [
  {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem 
              ...
              onClick={() => {
                if(confirm("Are you sure you want to delete this FaqItem?")) {
