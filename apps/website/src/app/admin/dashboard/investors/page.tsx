...
import { useInvestors } from "@/lib/admin/react-query/investors.hooks";
...
export default function InvestorsPage() {
  ...
  const canCreate = role === "Founder" || role === "admin" || role === "Super Admin" || role === "CEO" || role === "Finance";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {canCreate && (
          <Button asChild>
  <Link href="/admin/dashboard/investors/create">
