...
import { type InvestorType, investorsService } from "@/lib/admin/services/investors.service";
...
function roleHasWriteAccess(role: string | null) {
  return role === "Founder" || role === "admin" || role === "Super Admin" || role === "CEO" || role === "Finance";
}
